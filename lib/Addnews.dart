...
class _SetupInformationState extends State<SetupInformation> {
  ...
  Future<void> addData(
    ...
    Firestore.instance.collection("author").document(getID()).setData({
      "author_name": title,
      "author_pic_url": imageurl,
      "author_id": getID(),
      "author_short_bio": content,
      "author_sex":collection,
  ...
  Widget build(BuildContext context) {
    ...
    Future uploadPic(context, collection, title, content, uri, date) async {
      ...
      StorageReference fibasestorage =
          FirebaseStorage.instance.ref().child("author").child(filename);
